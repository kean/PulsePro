...
private let mockReposResponse = HTTPURLResponse(url: URL(string: "https://api.github.com/users/kean/repos")!, statusCode: 200, httpVersion: "2.0", headerFields: [
    "Content-Length": "2298",
    "Content-Type": "application/json; charset=utf-8",
    "Cache-Control": "no-store",
    "Content-Encoding": "gzip",
...
// MARK: - GitHub Contributors (Success)
