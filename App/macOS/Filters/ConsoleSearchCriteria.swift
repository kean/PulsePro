...
struct ConsoleSearchCriteriaPro: Hashable {
    ...
    static let `default` = ConsoleSearchCriteriaPro()

    var isDefault: Bool {
        self == ConsoleSearchCriteriaPro.default
    }
}
...
extension ConsoleSearchCriteria {
    ...
    static func update(request: NSFetchRequest<LoggerMessageEntity>, filterTerm: String, criteria: ConsoleSearchCriteriaPro, filters: [ConsoleSearchFilter], sessionId: String?, isOnlyErrors: Bool) {
